...
__published:	// IDE-managed Components
	...
	void __fastcall ComboBox1DrawItem(TWinControl *Control, int Index, TRect &Rect,
          TOwnerDrawState State);
	void __fastcall ComboBox1MeasureItem(TWinControl *Control, int Index, int &Height);
