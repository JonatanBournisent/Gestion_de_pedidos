...
void __fastcall TfGestionDeGastos::Button4Click(TObject *Sender)
{
   ...
   if(Application->MessageBox(L"Desea agregar este ítem?",L"Agregar un nuevo ítem de gasto?",MB_YESNO | MB_ICONWARNING | MB_DEFBUTTON2) != IDYES)
	  return;
...
void __fastcall TfGestionDeGastos::Button6Click(TObject *Sender)
{
   ...
   if(Application->MessageBox(L"Desea agregar esta categoría?",L"Agregar una nueva categoría de gasto?",MB_YESNO | MB_ICONWARNING | MB_DEFBUTTON2) != IDYES)
	  return;
