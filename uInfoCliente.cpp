...
void __fastcall TfInfoCliente::FormShow(TObject *Sender)
{
   ...
   if(Query1->FieldByName("CUIT")->AsString == "00000000" || Query1->FieldByName("CUIT")->AsString == "00-00000000-0")
   ...
   Label15->Caption = Query1->FieldByName("condicionFrenteIVA")->AsString;


   Query1->Close();
}
//---------------------------------------------------------------------------
void __fastcall TfInfoCliente::FormClose(TObject *Sender, TCloseAction &Action)
{
   Query1->Close();
