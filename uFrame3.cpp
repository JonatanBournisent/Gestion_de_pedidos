...
bool TFrame3::guardar(void)
{
   if(llamador == 1)
   {
	  ...
	  {
		 QueryAux->Close();
		 Application->MessageBox(L"El código asignado ya existe para otra comida. Ingrese uno diferente." ,L"No se realizaron cambios",MB_OK | MB_ICONERROR| MB_DEFBUTTON1);
		 return false;
	  }
